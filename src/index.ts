...
import { authController, categoriesController, dashboardController, favoritesControllers, paymentsController, productsController, rolesController, scoresControllers, usersController } from "./controllers";
